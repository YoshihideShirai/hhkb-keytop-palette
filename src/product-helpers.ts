...
import type { LayoutName, ProductAppearance, ProductId, ProductSeries } from "./types";
...
export function defaultProductForSeries(series: ProductSeries): ProductAppearance | undefined {
